...
#ifdef _DEBUG
    chrono::steady_clock::time_point time_end_read_header = chrono::steady_clock::now();
    chrono::duration<double> duration_read_header = chrono::duration_cast<chrono::duration<double>>(time_end_read_header - time_start);
...
#ifdef _DEBUG
    chrono::steady_clock::time_point time_end_read_body = chrono::steady_clock::now();
    chrono::duration<double> duration_read_body = chrono::duration_cast<chrono::duration<double>>(time_end_read_body - time_end_read_header);
