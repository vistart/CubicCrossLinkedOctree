...
PlyEdge::PlyEdge(std::vector<EdgeName> const& names, std::string const& edge)
{
...
PlyEdge::PlyEdge(std::vector<EdgeName> const& names, std::fstream& f, PlyFileEncoding::FileEncoding const& fe)
{
    int vertex1 = 0, vertex2 = 0;
    unsigned int __R = 0, __G = 0, __B = 0;
    unsigned char R = 0, G = 0, B = 0;
...
PlyEdge::PlyEdge(int v1, int v2, unsigned char R, unsigned char G, unsigned char B)
{
