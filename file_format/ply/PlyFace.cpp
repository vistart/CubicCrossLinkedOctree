...
PlyFace::PlyFace(FaceDescription const& fd, std::string const& str_face)
{
...
PlyFace::PlyFace(FaceDescription const& fd, std::fstream& file, PlyFileEncoding::FileEncoding const& file_encoding)
{
    unsigned int size = 0;
