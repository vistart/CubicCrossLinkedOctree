...
#define __rand_m 0x100000000LL  
#define __rand_c 0xB16  
#define __rand_a 0x5DEECE66DLL  

static unsigned long long seed = 1;

double drand48(void)
{
	seed = (__rand_a * seed + __rand_c) & 0xFFFFFFFFFFFFLL;
	unsigned int x = seed >> 16;
	return  ((double)x / (double)__rand_m);
